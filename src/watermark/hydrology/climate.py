...
The live pull is :func:`watermark.hydrology.connectors.nasa_power.fetch_climatology`; this
module persists its result to ``data/reference/hydrology/nasa-power-climatology.yaml``
and loads it back, mirroring :mod:`watermark.hydrology.maumee` and
:mod:`watermark.hydrology.floodplain`. The committed table is what the offline-

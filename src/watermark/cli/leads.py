...
from watermark.cli._base import console, get_settings, leads_app
from watermark.site import leads as leads_mod
from watermark.site.gh_leads import GithubLeadsError, fetch_site_issues, issue_to_lead, merge_leads
...
def leads_sync(
    ...
    :class:`~watermark.site.feeds.LeadItem`s and merged with any hand-curated entries
    ...
    if fixture:
        ...
        from watermark.site.gh_leads import GithubIssue, _extract_labels

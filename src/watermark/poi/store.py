...
The ``tracked_pois`` view is what `watermark.gis` consumes: POIs at ``depth: watched`` with
...
from watermark.poi.model import POIFrontmatter, POIProfile
...
def split_frontmatter(text: str) -> tuple[str, str]:
    ...
    splitter in :mod:`watermark.people` — kept local so the POI store stands alone.)
    """

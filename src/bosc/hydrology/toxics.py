...
:mod:`bosc.hydrology.assimilative` screens the three *municipal* WWTPs against
...
(:mod:`bosc.rsei`), placed on the same receiving reaches and read against the same
cited low flows (:mod:`bosc.hydrology.lowflow`).

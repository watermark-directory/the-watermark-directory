...
pure-pydantic leaf :mod:`bosc.connectors.gis_schema`; the per-jurisdiction *instances*
live here (and are re-exported by :mod:`bosc.sites`), where site-specific field names /

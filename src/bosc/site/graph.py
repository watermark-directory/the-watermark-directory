...
Reuses the structured returns of :func:`bosc.pipeline.timeline.build_timeline` and
:func:`bosc.pipeline.entities.build_entity_graph` and emits the :mod:`bosc.site.feeds`

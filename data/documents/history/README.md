# History — place-history reference sources

**Collection:** `history/` · immutable source evidence · public domain

Secondary and tertiary place-history sources relevant to the Lima watershed point and
the Allen County / Maumee headwaters corridor. These are **reference** sources
(cited `[reference]`), not regulatory or transactional records, so they inform

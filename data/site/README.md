...
| `gis-findings.geojson` | The **GIS findings map** layers (WGS84): the campus footprint, the JSMC / Lima Army Tank Plant land, and the nearby FEMA floodplain/floodway. Copied to the site as an asset and drawn by `gis-map.md` (Leaflet). Regenerated from the county/FEMA GIS (geometry server-generalized). |

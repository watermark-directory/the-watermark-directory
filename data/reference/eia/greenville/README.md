...
Per-site onboarding tree for the Greenville · Darke Co watershed point (basin: great-miami), scaffolded by `bosc onboard greenville` (#326). Values come from the portable reach connectors keyed to this site's `SiteProfile` in `bosc.sites` — nothing here is fabricated; regenerate, don't hand-edit.

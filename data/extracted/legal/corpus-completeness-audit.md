...
**Framework + outfall coverage now in-corpus (2026-06-16) — campus #143 still open.** Two pieces of this thread were ingested 2026-06-16. (1) The governing **statewide** general permit **OHC000006** (+ its Response to Comments) is committed at [`../regulatory/ohc000006-construction-stormwater-gp.yaml`](../regulatory/ohc000006-construction-stormwater-gp.yaml) — so the standard is now primary-source: a complete NOI is due *"at least 21 days … prior to the commencement of construction activity"* and *"Coverage under this permit is not effective until an approval letter … is received."* (2) The **BOSC Storm Outfall**'s own coverage is now end-to-end on the record — its SWP3 Appendix A was acquired as eDoc **4091289**, the Ohio EPA approval letter assigning Facility Permit Number **`2GC08747*AG`** (effective 2026-04-22 under OHC000006; Igel/WSP). Note the per-site number format is `2GC…*AG`, **not** an `OHC…` number. **Neither resolves the campus #143:** the 195-ac mass-grading under Turner/SW1225 still has no produced coverage record — only now the governing standard and an adjacent-project exemplar make the campus "TBD" more conspicuous.

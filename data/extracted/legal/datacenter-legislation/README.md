...
| `local-ballot-2026-11.md` | Network-level reading of the **local data-center measures on the 2026-11-03 ballots** — 17 communities against reporting headlined "18", with the reconciliation gap left open. Standings are mixed, not uniform: ten certified, one ordered onto the ballot by the Supreme Court of Ohio, four unconfirmed, one election undetermined, plus one further initiative (nested under Wilmington) that a board of elections refused. Counties, instrument types (charter amendment / zoning referendum / initiative), thresholds (7.5 / 20 / 25 MW / full ban), certifying bodies, the four measures the brief did not carry, and the traps that collapse them. |

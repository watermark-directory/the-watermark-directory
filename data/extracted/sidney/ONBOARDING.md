...
- Proposals filed as sub-issues of **#481**: derive the Great Miami / Loramie 7Q10; build the Great Miami ECHO NPDES discharger inventory; pin the Shelby County retail utility + EIA-861 number (unblocks `grid-profile`); run the Sidney / Shelby-County data-center sweep.

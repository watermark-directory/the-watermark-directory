...
- [ ] **Data-center activity** — `[open]`, the research target: the Columbus-metro cluster + the AEP data-center-tariff exposure (the New Albany epicenter is immediately NE). The self-research first pass (`--research`, #247) has **not** been run. No facility is in the corpus/entity graph yet.

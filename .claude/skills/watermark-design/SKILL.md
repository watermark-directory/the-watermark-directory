...
- **[`design/readme.md`](../../../design/readme.md)** — the full
...
- **`design/components/`**, **`ui_kits/`**, **`guidelines/`** — React `.jsx`
...
The **live site** is Astro (`web/src/`); its `.astro` components in
`web/src/components/` are the *implementations* of these specs, and `web/src/styles/site.css`
...
follow **[`design/DESIGNSYNC.md`](../../../design/DESIGNSYNC.md)**

...
A **minimal, trimmed snapshot** of the real content bundle (`watermark export` →
...
```sh
watermark export                       # writes data/site/bundle/ (the loader prefers it)
# or point anywhere:
...
```sh
watermark export --out /tmp/bundle

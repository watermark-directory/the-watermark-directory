...
const legal = defineCollection({
  loader: glob({
    pattern: [
      ...
      "legal/prr-mandamus/network/american-sugar-creek-allen-co-prr-production-*.analysis.md",
      "legal/prr-mandamus/README.md",
      "legal/corpus-completeness-audit.md",
      "legal/web-vendor-audit/*.md",
      "commissioners/README.md",
      "commissioners/network/american-sugar-creek-allen-co-water-balance.analysis.md",
    ],
    base: "../data/extracted",

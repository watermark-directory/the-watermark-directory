...
function LeadsBoard({ onBack }) {
  ...
  const LEADS = [
    ...
    { kind: "Claim", confidence: "rumored", title: "A 200 MW substation upgrade is planned", detail: "Heard at a zoning meeting; no filing found yet. Corroborate with a document?", source: "Public comment", action: "Corroborate", count: "1 corroboration", g: "signal" },

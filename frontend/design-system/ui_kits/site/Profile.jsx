...
// mention this entity + a back link.
function ProfileScreen({ onBack }) {
  ...
  const PROFILE = {
    ...
    descriptor: "Delaware LLC; grantee on the seven-parcel deed chain. Shares a registered agent and PMB with two sibling shells — the common-control plumbing the walk traces in Chapter 1.",
    evidence: "inference", graph: true, relLabel: "Graph neighborhood",
    stats: [
    ...
    relationships: [
      { kind: "grantor", label: "Brenneman Trusts" },
      { kind: "sibling", label: "Tilted Gate LLC" },
      { kind: "contractor", label: "Tetra Tech" },
    ],
  };
  const records = [
    { title: "Limited Warranty Deed", recordId: "instr. 202508130008300", source: { collection: "Allen County Recorder" }, evidence: "verified", headlineValue: "$600,000" },
